...
public class Batt2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_batt2);
    ...
    private void callCommon(){
        stateBattery = 0;
//        Intent intent = new Intent(Batt2Activity.this, MainActivity.class);
